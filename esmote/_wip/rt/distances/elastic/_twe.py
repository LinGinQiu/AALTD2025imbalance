...
def twe_distance(
    ...
    --------
    >>> import numpy as np
    >>> from esmote._wip.rt.distances import twe_distance
...
def twe_cost_matrix(
    ...
    --------
    >>> import numpy as np
    >>> from esmote._wip.rt.distances import twe_cost_matrix
...
def twe_pairwise_distance(
    ...
    **kwargs,
    ...
    --------
    >>> import numpy as np
    >>> from esmote._wip.rt.distances import twe_pairwise_distance
...
def twe_alignment_path(
    ...
    --------
    >>> import numpy as np
    >>> from esmote._wip.rt.distances import twe_alignment_path
    >>> x = np.array([[1, 2, 3, 6]])
    >>> y = np.array([[1, 2, 3, 4]])
